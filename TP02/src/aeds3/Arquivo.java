...
public class Arquivo<T extends Registro> {
    ...
    HashExtensivel<ParIdEndereco> idxDireto;
    ...
    public int create(T obj) throws Exception {
        ...
        idxDireto.create(ParIdEndereco.create(nextId, address));
        return obj.getId();
    }
    ...
    public T read(int id) throws Exception {
        ...
        ParIdEndereco pid = idxDireto.read(id);
        if(pid!=null) {
    ...
    public boolean delete(int id) throws Exception {
        ...
        if(pie != null) {
            ...
            if(lapide == ' ') {
                ...
                if(obj.getId() == id && idxDireto.delete(id)) {
                    file.seek(pie.getEndereco());
                    file.write('*');
    ...
    public boolean update(T novoObj) throws Exception {
        ...
        ParIdEndereco pie = idxDireto.read(novoObj.getId());
        if(pie!=null) {
            file.seek(pie.getEndereco());
            obj = pClass.getConstructor().newInstance();
            lapide = file.readByte();
            if(lapide == ' ') {
                ...
                if(obj.getId()==novoObj.getId()) {
                    ...
                    if(tam2 <= tam) {
                        ...
                        idxDireto.update(ParIdEndereco.create(novoObj.getId(), novoaddress));
                    }
                    return true;
                }
            }
