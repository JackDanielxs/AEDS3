...
public class ListaInvertida {
  ...
  public ListaInvertida(int n, String nd, String nc) throws Exception {
    ...
    nomeArquivoDicionario = "data/" + nd + ".listainv.db";
    nomeArquivoBlocos = "data/" + nc + ".listainv.db";

    File file = new File(this.nomeArquivoDicionario);
    if (!file.exists()) {
    ...
    file = new File(this.nomeArquivoBlocos);
