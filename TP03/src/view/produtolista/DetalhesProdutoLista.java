...
public final class DetalhesProdutoLista extends View {
    ...
    public DetalhesProdutoLista set(final int productGiftListId) {
        this.productGiftList = ProdutoListaPresenteController.INSTANCE.findById(productGiftListId);
        this.productGiftListId = productGiftListId;
        this.product = ProdutoController.INSTANCE.getById(productGiftList.getProductId());
